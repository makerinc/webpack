	...
	constructor(outputOptions) {
		...
		this.plugin("require-extensions", (source, chunk, hash) => {
			...
			if(Object.keys(chunkMaps.hash).length) {
				...
				// Grabbed from webpack 4 to fix "__webpack_require__.e is not a function"
				// https://github.com/webpack/webpack/issues/8110
				// https://github.com/webpack/webpack/blob/9fe42e7c4027d0a74addaa3352973f6bb6d20689/lib/MainTemplate.js#L250
				chunk.hasModuleInGraph(m =>
					m.blocks.some(b => b.chunks.length > 0)
				)
			) {
				...
				buf.push(this.indent("return Promise.resolve();"));
				buf.push("};");
			}
			buf.push("");
